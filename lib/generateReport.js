...
async function generateReport() {
  ...
  // Copy screenshots directory for non-embedded mode when screenshots are included in HTML
  if (!reporterOptions.embeddedScreenshots && reporterOptions.addScreenshotToHTML !== false) {
